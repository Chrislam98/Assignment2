...
public class AddNewProduct extends AppCompatActivity {
    ...
    private void ValiddateProductData() {
    ...
    private void StoreProductInformation() {
        ...
        loadingBar.setMessage("Dear Admin, while we are adding the new product.");
                ...
                Task<Uri> urlTask= uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(AddNewProduct.this, "got the Product image save to Database Successfully...", Toast.LENGTH_SHORT).show();
